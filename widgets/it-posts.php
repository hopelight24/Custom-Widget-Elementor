...
class IT_Posts_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'IT Posts', 'custom-widget-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'it_post_query',
			[
				'label' => __( 'Post Query', 'custom-widget-elementor' ),
        ...
        $this->add_control(
			'it_post_type',
			[
				'label' => esc_html__( 'Post Type', 'custom-widget-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'Post',
				'options' => [
					'Post'  => esc_html__( 'Posts', 'custom-widget-elementor' ),
					'Place'  => esc_html__( 'Places', 'custom-widget-elementor' ),
                    'City'  => esc_html__( 'Cities', 'custom-widget-elementor' ),
                    'State'  => esc_html__( 'States', 'custom-widget-elementor' ),
				],
			]
		);
		// Posts Per Page
		$this->add_control(
			'it_posts_count',
			[
				'label' => __( 'Posts Per Page', 'custom-widget-elementor' ),
        ...
        $this->add_control(
            'it_near_post',
            [
                'label' => esc_html__( 'Near Posts', 'custom-widget-elementor' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'custom-widget-elementor' ),
                'label_off' => esc_html__( 'Hide', 'custom-widget-elementor' ),
                'return_value' => 'yes',
                'default' => 'no',
            ]
        );
        $this->add_control(
            'it_more_post',
            [
                'label' => esc_html__( 'More Posts', 'custom-widget-elementor' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'custom-widget-elementor' ),
                'label_off' => esc_html__( 'Hide', 'custom-widget-elementor' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'it_by_author',
            [
                'label' => esc_html__( 'Place By Author', 'custom-widget-elementor' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'custom-widget-elementor' ),
                'label_off' => esc_html__( 'Hide', 'custom-widget-elementor' ),
                'return_value' => 'yes',
...
<div class="it-post-card">
    ...
    <?php
        ...
        // If no posts match this query, output this text.
            _e( 'Sorry, no posts matched your criteria.', 'custom-widget-elementor' );
